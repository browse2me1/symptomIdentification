...
if (isset($_SESSION['username'])) {
    if ($_SESSION['role'] === 'admin') {
        header("Location: Include/user/admin/manage.php");
    } else {
...
<body>
   <div class="logo">
    ...
    <em>This system helps users to identify possible diseases based on the symptoms they experience, promoting early detection and public health awareness.</em>
